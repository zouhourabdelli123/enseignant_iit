...
@section('content')
    ...
    <div class="page-container">
        ...
        <!-- FORM -->
        <div class="form-card">
            <form id="requestForm" action="{{ route('ajout_demande_enseigniant') }}" method="POST"
                ...
                <div class="form-group">
                    <label for="body" class="form-label">Contenue</label>
                    <textarea id="body" name="contenue" class="form-textarea"
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-area" id="fileUploadArea">
                        <input type="file" id="pieceJointe" name="document" class="file-input"
